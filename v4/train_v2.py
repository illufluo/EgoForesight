"""
V4 Training Round 2: fine-tune Qwen3.5-9B on filtered data, lower lr, more epochs.

Changes from v4/train.py:
- learning_rate: 2e-4 → 5e-5
- num_train_epochs: 3 → 5
- output_dir: outputs/v4 → outputs/v4_run2
- train/val paths: training_v4/ → training_v4_filtered/
...
TRAIN_PATH  = "/root/sdp/data/training_v4_filtered/train.json"
VAL_PATH    = "/root/sdp/data/training_v4_filtered/val.json"
OUTPUT_DIR  = "/root/sdp/outputs/v4_run2"
IMAGE_BASE  = "/root/sdp"
MAX_SEQ_LEN = 2048
