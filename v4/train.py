"""
V4 Training: fine-tune Qwen3.5-9B on action prediction (no history).
...
TRAIN_PATH  = "/root/sdp/data/training_v4/train.json"
VAL_PATH    = "/root/sdp/data/training_v4/val.json"
OUTPUT_DIR  = "/root/sdp/outputs/v4"
IMAGE_BASE  = "/root/sdp"
MAX_SEQ_LEN = 2048
