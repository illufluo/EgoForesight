"""
V5 Training Round 2: fine-tune Qwen3.5-9B WITH history on filtered data, lower lr, more epochs.

Changes from v5/train.py:
- learning_rate: 2e-4 → 5e-5
- num_train_epochs: 3 → 5
- output_dir: outputs/v5 → outputs/v5_run2
- train/val paths: training_v5/ → training_v5_filtered/
...
TRAIN_PATH  = "/root/sdp/data/training_v5_filtered/train.json"
VAL_PATH    = "/root/sdp/data/training_v5_filtered/val.json"
OUTPUT_DIR  = "/root/sdp/outputs/v5_run2"
IMAGE_BASE  = "/root/sdp"
MAX_SEQ_LEN = 2048
