"""
V5 Quick Inference Test: load fine-tuned model (with history), run on a few test samples.
...
ADAPTER_PATH = "/root/sdp/outputs/v5/lora_adapter"
TEST_PATH    = "/root/sdp/data/training_v5/test.json"
IMAGE_BASE   = "/root/sdp"
